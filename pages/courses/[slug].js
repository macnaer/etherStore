...
export default function Course({ course }) {
  ...
  const isLocked =
    !courseState || courseState === "Orderd" || courseState === "deactivated";
        ...
        <div className="max-w-5xl mx-auto">
          {courseState === "Orderd" && (
            <Message type="warning">
              Course is Orderd and waiting for the activation. Process can take
              up to 24 hours.
          ...
          {courseState === "deactivated" && (
            <Message type="danger">
              Course has been deactivated, due the incorrect Order data. The
